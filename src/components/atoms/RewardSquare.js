...
const RewardSquare = (props) => {
    ...
    return (
        <View style={{ height: 140, width: 140, borderRadius: 20, alignItems: "center", justifyContent: "center", backgroundColor: color, margin: 8, padding:10 }}>
           ...
           amount ?  <PoppinsText content={amount} style={{ fontSize: 18, color: 'black' }}></PoppinsText> : <AnimatedDots color={'black'}/>
            ...
            <PoppinsTextMedium content={title} style={{ fontSize: 16, color: 'black', marginBottom:10 }}></PoppinsTextMedium>
        </View>
    );
}
