    ...
    return (
        <View style={{ alignItems: "center", justifyContent: "flex-start" }}>
            <View style={{ alignItems: "center", justifyContent: "flex-start", flexDirection: "row", width: '100%', marginTop: 10, height: 40, marginLeft: 20 }}>
                ...
                <PoppinsTextMedium content="Transaction History" style={{ marginLeft: 10, fontSize: 16, fontWeight: '600', color: '#171717' }}></PoppinsTextMedium>
            ...
            <View style={{ padding: 14, alignItems: "flex-start", justifyContent: "flex-start", width: "100%", }}>
                <View style={{ flexDirection: 'row' }}>
                    ...
                    <PoppinsText style={{ marginLeft: 10, fontSize: 34, fontWeight: '600', color: ternaryThemeColor }} content={`${cashback}`}></PoppinsText>
                </View>
