...
const Introduction = ({navigation}) => {
    ...
    const descriptionImages=[require('../../../assets/images/genuinemarkDescription.png'),]
    ...
    return (
        <ImageBackground source={descriptionImages[imageIndex]} style={{backgroundColor:"#F2F2F2",height:'100%',width:'100%',flex:1}}>
